package com.cxy.util.mobilephone;
...
public class MobilePhoneUtil {
	...
	public static Map<String, Object> getPhoneInfo(String phone){
		Map<String, Object> jo = new HashMap<String, Object>(0);
		
		CloseableHttpClient httpclient = HttpClients.createDefault();
		HttpGet httpGet = new HttpGet(SecretConstant.MobilePhoneNumUrl + "?phone=" + phone + "&key=" + SecretConstant.MobilePhoneNumKey);
